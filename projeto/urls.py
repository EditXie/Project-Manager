...
urlpatterns = [
    ...
    url(
        r"^tarefa/(?P<id_tarefa>\d+)/iniciar$",
        views.iniciar_tarefa,
        name="iniciar_tarefa"
    ),
    url(
        r"^tarefa/(?P<id_tarefa>\d+)/pausar$",
        views.pausar_tarefa,
        name="pausar_tarefa"
    ),
    url(
        r"^tarefa/(?P<id_tarefa>\d+)/concluir$",
        views.concluir_tarefa,
        name="concluir_tarefa"
    ),
    url(
        r"^tarefa/(?P<id_tarefa>\d+)/deletar$",
        views.deletar_tarefa,
        name="deletar_tarefa"
    ),

    url(
        r"^tarefa/(?P<id_tarefa>\d+)/comentar/$",
        views.comentar,
        name="comentar"
    ),

    url(
        r"^tarefa/(?P<id_tarefa>\d+)/permitido_iniciar/$",
